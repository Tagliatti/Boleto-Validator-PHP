...
class BoletoValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Testa um boleto que não possui vencimento e valor na linha digitável
     */
    public function testBoletoSemVencimentoAndValor()
    {
        $this->assertTrue(BoletoValidator::boleto('42297.11504 00001.954411 60020.034520 2 000'));
    }
     ...
     * @expectedException Exception
     */
    public function testInvalid36WithOneMoreChar()
    {
        $this->assertTrue(BoletoValidator::boleto('42297.11504 00001.954411 60020.034520 2 0001'));
    }
     ...
     * @expectedException Exception
     */
    public function testInvalid36WithLetter()
    {
        $this->assertTrue(BoletoValidator::boleto('42297.11504 00001.954411 60020.034520 2 00a'));
    }

    /**
     * Passando números diferentes de zero no final
     *
     * @expectedException Exception
     */
    public function testInvalid36WithNoZerosOnEnd()
    {
        $this->assertTrue(BoletoValidator::boleto('42297.11504 00001.954411 60020.034520 2 011'));
    }
