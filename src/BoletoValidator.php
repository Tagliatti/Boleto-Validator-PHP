...
class BoletoValidator {
     ...
     */
    public static function codigoBarras($codigoBarras) {
        
        if (preg_match("/^[0-9]{11}-[0-9] [0-9]{11}-[0-9] [0-9]{11}-[0-9] [0-9]{11}-[0-9]$/", $codigoBarras)) {
            throw new \Exception("Envalid format. The correct format is: 00000000000-0 00000000000-0 00000000000-0 00000000000-0.");
        }
    ...
    public static function linhaDigitavel($linhaDigitavel) {
